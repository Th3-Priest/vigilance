...
#define LOAD_FONT2 // 16 px proportional font used by the Vigilance HUD
...
// Vigilance : un module LoRa se branche sur le MEME header amovible que le CC1101
// (SPI partage + CS + GDO). Broches LoRa par defaut = header CC1101, pour qu'un
// module LoRa swappe fonctionne des le branchement. SPI+CS sont surs ; RST/DIO0
// sur les GDO sont une hypothese a ajuster selon le module (Config > Pins > LoRa
// Pins). SX1262 exige en plus -DLORA_BUSY (une broche BUSY non exposee ici).
#define LORA_SCK SPI_SCK_PIN
#define LORA_MISO SPI_MISO_PIN
#define LORA_MOSI SPI_MOSI_PIN
#define LORA_CS CC1101_SS_PIN
#define LORA_RST CC1101_GDO2_PIN
#define LORA_DIO0 CC1101_GDO0_PIN
