...
static const RfProtocolDef rf_protocols[] = {
    ...
    // ---- Vigilance: variantes 24 bits (memes timings que les 12 bits, gerees par le Flipper) ----
    {"CAME_24bit",    320, {36, 1},   {2, 1},   {1, 2},   24, true,  SYNC | FIXED},
    {"NICE_FLO_24bit",700, {1, 36},   {2, 1},   {1, 2},   24, false, SYNC | FIXED},
