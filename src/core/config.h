...
public:
    ...
    const char *filepath = "/Vigilance.conf";
    ...
    WiFiCredential wifiAp = {"VigilanceNet", "vigilance"};
    ...
    std::vector<QrCodeEntry> qrCodes = {
        {"Vigilance AP",  "WIFI:T:WPA;S:VigilanceNet;P:vigilance;;"},
        {"Upstream Wiki", "https://github.com/pr3y/Bruce/wiki"     },
        {"Upstream Site", "https://bruce.computer"                 },
